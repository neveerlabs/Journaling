...
export default function LoginPage() {
  ...
  React.useEffect(() => {
    ...
    if (err) setMessage({ intent: 'error', text: 'Authentication failed. Please try again.' })
  }, [searchParams])
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (mode === 'signin') {
      ...
      if (error) setMessage({ intent: 'error', text: error.message })
      else setMessage({ intent: 'success', text: 'Check your email to confirm your account.' })
    }
    ...
    <div className={styles.page}>
      <Card className={styles.card}>
        ...
        <form className={styles.form} onSubmit={handleSubmit}>
          ...
          >
            {loading ? <Spinner size="tiny" /> : mode === 'signin' ? 'Sign in' : 'Sign up'}
          </Button>
        </form>
